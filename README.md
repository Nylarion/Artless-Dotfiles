# Artless-Dotfiles
Mis dotfiles, no pretendo que sea nada impresionante, solo son para dejar Hyprland con Waybar medianamente bonito y minimal.
...
- Instalación: sudo pacman -S starship

### Cava:

- Instalación: sudo pacman -S cava
